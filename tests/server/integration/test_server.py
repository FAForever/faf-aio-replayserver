...
@pytest.mark.asyncio
@pytest.mark.timeout(1)
async def test_server_good_data(client, put_replay, replay_data):
    """
    Server will accept good data
    """
    reader, writer = await client()

    writer.write(put_replay)
...
@pytest.mark.asyncio
@pytest.mark.timeout(1)
async def test_replay_multiple_data_send(client, put_replay, replay_data):
    """
...
@pytest.mark.asyncio
@pytest.mark.timeout(1)
async def test_server_save_data(client, put_replay, replay_data, replay_id, db_replay):
    """
